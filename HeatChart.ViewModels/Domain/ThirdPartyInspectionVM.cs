...
{
    /// <summary>
    /// HeatChart ThirdPartyInspection Information
    /// </summary>
    public class ThirdPartyInspectionVM : IValidatableObject
    {
        ...
        public string AdditionalDetails { get; set; } // To store any additional details of the thirdPartyInspection. 
        ...
        {
            var validator = new ThirdPartyInspectionVMValidator();
