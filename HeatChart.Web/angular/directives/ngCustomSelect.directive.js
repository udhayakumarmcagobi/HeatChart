(function (app) {
    ...
    app.directive('ngCustomSelect', ['$parse', '$compile', '$timeout', '$q', 'customSelectDefaults', function ($parse, $compile, $timeout, $q, baseOptions) {
        ...
        return {
            ...
            link: function (scope, elem, attrs, controller) {
                var customSelect = attrs.ngCustomSelect;
                if (!customSelect) {
                    throw new Error('Expected ng-custom-select attribute value.');
                }
                ...
                elem.addClass('dropdown ng-custom-select');
                ...
                var itemTemplate = elem.html().trim() || '{{' + (match[2] || match[1]) + '}}',
                    ...
                    '<div class="dropdown-menu">' +
                        '<div stop-propagation="click" class="ng-custom-select-search">' +
                        ...
                        '<ul role="menu">' +
                            ...
                            '</li>' +
                        '</ul>' +
                        '<div class="ng-custom-select-action">' +
